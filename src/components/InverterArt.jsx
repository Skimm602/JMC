    ...
    <svg viewBox="0 0 360 470" className={className} role="img" aria-label="JMC H6 hybrid inverter, front view">
      <defs>
        <linearGradient id="chassis" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#3c443e" />
          <stop offset="45%" stopColor="#252c27" />
          <stop offset="100%" stopColor="#151a17" />
        </linearGradient>
        <linearGradient id="finFace" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#48514a" />
          <stop offset="100%" stopColor="#282f2a" />
        </linearGradient>
        ...
        <linearGradient id="topEdge" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="rgba(232,234,227,0)" />
          <stop offset="50%" stopColor="rgba(232,234,227,0.35)" />
          <stop offset="100%" stopColor="rgba(232,234,227,0)" />
        </linearGradient>
      </defs>

      {/* mounting bracket peeking out behind the chassis */}
      <rect x="52" y="26" width="256" height="18" rx="2" fill="#121714" opacity="0.9" />

      {/* main chassis */}
      <rect x="40" y="34" width="280" height="404" rx="6" fill="url(#chassis)" stroke="#525b53" strokeWidth="1.2" />
      ...
      <g>
        ...
        {fins.map((x) => (
          <rect key={`hl-${x}`} x={x} y="58" width="1.5" height="118" fill="#69736a" opacity="0.5" />
        ))}
      </g>

      {/* model plate */}
      <rect x="66" y="192" width="228" height="26" rx="2" fill="#10150f" stroke="#434c44" strokeWidth="1" />
      <text
        x="78"
        y="209.5"
      ...
      {/* display */}
      <rect x="66" y="232" width="228" height="104" rx="3" fill="url(#screen)" stroke="#434c44" strokeWidth="1.2" />
      <text
        x="82"
        y="262"
        fill="var(--color-glint-faint)"
        fontFamily="var(--font-plex-mono), monospace"
        fontSize="10"
        letterSpacing="2"
      >
      ...
      <g>
        ...
        <circle cx="134" cy="366" r="5.5" fill="#2a322c" />
        <text
          x="152"
          y="370"
          fill="var(--color-glint-faint)"
      ...
      <g fill="#0c100e" stroke="#434c44" strokeWidth="1">
